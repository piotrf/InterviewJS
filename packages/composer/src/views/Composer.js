          ...
          <PageBody>
            <Container flex={[1, 1, `${100 / 3}%`]} className="jr-step2">
              <IntervieweePane
                ...
                editMode={!!(this.state.currentBubble && storyline[this.state.currentBubble].role === "interviewee")}
              />
            </Container>
            ...
            <Container flex={[1, 1, `${100 / 3}%`]} className="jr-step4">
              <UserPane
                ...
                storyIndex={storyIndex}
                showSavedIndicator={this.showSavedIndicator}
                editMode={!!(this.state.currentBubble && storyline[this.state.currentBubble].role === "user")}
              />
            </Container>
          </PageBody>
        </ErrorBoundary>
