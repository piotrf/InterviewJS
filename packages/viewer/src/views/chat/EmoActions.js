...
const EmoActions = (props) => [
  <Action
    iconic
    onClick={() => props.updateHistory("emoji", "smile")}
    key="smile"
  >
  ...
  <Action
    iconic
    onClick={() => props.updateHistory("emoji", "angry")}
    key="angry"
  >
  ...
  <Action
    iconic
    onClick={() => props.updateHistory("emoji", "shocked")}
    key="shocked"
  >
  ...
  <Action
    iconic
    onClick={() => props.updateHistory("emoji", "neutral")}
    key="neutral"
  >
  ...
  <Action
    iconic
    onClick={() => props.updateHistory("emoji", "wondering")}
    key="wondering"
  >
